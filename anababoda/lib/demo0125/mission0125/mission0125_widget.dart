      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20, 0, 0, 0),
              child: StreamBuilder<List<StepperRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<StepperRecord> rowStepperRecordList = snapshot.data!;
                  // Return an empty Container when the item does not exist.
                  if (snapshot.data!.isEmpty) {
                    return Container();
                  }
                  final rowStepperRecord = rowStepperRecordList.isNotEmpty
                      ? rowStepperRecordList.first
                      : null;
                  return InkWell(
                    splashColor: Colors.transparent,
                    focusColor: Colors.transparent,
                    ...
                    onTap: () async {
                      ...
                      if (dateTimeFormat(
                        ...
                        await rowStepperRecord!.reference
